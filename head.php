...
<div id="hd">
    ...
    <div id="hd_wrapper">
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_THEME_IMG_URL ?>/logo_img.png" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
...
<?php if (!defined("_INDEX_")) { ?> 
    ...
    .subTopBg_04{ background-image: url(<? echo G5_THEME_IMG_URL?>/pc02.jpg);}
    </style>
